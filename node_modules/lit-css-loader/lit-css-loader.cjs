...
// packages/lit-css-loader/lit-css-loader.ts
var lit_css_loader_exports = {};
__export(lit_css_loader_exports, {
  default: () => lit_css_loader_default
});
module.exports = __toCommonJS(lit_css_loader_exports);
...
// packages/lit-css-loader/lit-css-loader.ts
var loader = function loader2(css) {
  const callback = this.async();
  const filePath = this.resourcePath;
  const options = this.getOptions();
  const { specifier, tag, uglify, ...rest } = options != null ? options : {};
  transform({ css, specifier, tag, uglify, filePath, ...rest }).then((result) => {
    callback(null, result);
  }).catch((err) => {
    callback(err, css);
  });
};
var lit_css_loader_default = loader;
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {});
//# sourceMappingURL=lit-css-loader.cjs.map
